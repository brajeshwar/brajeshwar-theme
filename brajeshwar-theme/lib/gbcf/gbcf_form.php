...
<!-- Required Info -->
      <fieldset>
       <legend>Required contact info:</legend>
        <label for="name">Enter your full name<?php echo(''.$x_or_h_br.''); ?><input tabindex="<?php echo(''.$tab_name.''); ?>" class="med" type="text" name="name" id="name" size="35" maxlength="40" value=""<?php echo(''.$x_or_h_in.''); ?>></label><?php echo(''.$x_or_h_br.''); ?> 
        <label for="email">Enter your email address<?php echo(''.$x_or_h_br.''); ?><input tabindex="<?php echo(''.$tab_email.''); ?>" class="med" type="text" name="email" id="email" size="35" maxlength="40" value=""<?php echo(''.$x_or_h_in.''); ?>></label>
      </fieldset>
<!-- Optional Info -->
      <fieldset>
...
<!-- Required Form Comments Area -->
      <fieldset>
       <legend>Required comments area:</legend>
        <label for="message">Enter your message<?php echo(''.$x_or_h_br.''); ?><textarea tabindex="<?php echo(''.$tab_message.''); ?>" class="textbox" rows="12" cols="60" name="message" id="message"></textarea></label>
      </fieldset>
