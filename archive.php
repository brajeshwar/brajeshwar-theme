...
<!-- BEGIN post -->
<div class="post">
<h2 class="post-title"><a href="<?php echo get_permalink() ?>" rel="bookmark" title="<?php the_title(); ?>"><?php the_title(); ?></a></h2>
...
<div class="post-body">
<?php the_excerpt(); ?>
<p>&rarr; <a href="<?php echo get_permalink() ?>" title="<?php the_title(); ?>">Read the article</a></p>
</div>
</div>
<?php endwhile; ?>
<!-- END post -->
